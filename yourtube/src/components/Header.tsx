...
const Header = () => {
  ...
  return (
    <header className="flex items-center justify-between px-2 sm:px-4 py-2 bg-background border-b">
      ...
      <form
        ...
        className="flex items-center gap-1 sm:gap-2 flex-1 max-w-2xl mx-2 sm:mx-4 min-w-0"
      >
        <div className="flex flex-1 ">
          <Input
            ...
            className="rounded-l-full border-r-0 bg-transparent text-white placeholder:text-gray-400 focus-visible:ring-0"
          />
          <Button
            type="submit"
            className="rounded-r-full px-3 sm:px-6 bg-secondary hover:bg-accent text-foreground border border-l-0 border-border"
          >
